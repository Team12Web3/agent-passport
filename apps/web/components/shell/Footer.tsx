...
export function Footer() {
  return (
    <footer className="border-t border-white/[0.07] bg-white/[0.018]">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-3 px-6 py-6 text-sm text-muted sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 font-medium text-fg transition hover:text-[var(--accent)]"
        >
