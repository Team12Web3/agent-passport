      ...
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-5 py-10">
        ...
        {!client ? (
          <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-sm text-amber-100">
            Set <span className="font-mono">NEXT_PUBLIC_THIRDWEB_CLIENT_ID</span> in <span className="font-mono">.env.local</span>{" "}
            (from your thirdweb dashboard), then restart <span className="font-mono">npm run dev</span>.
          </div>
        ) : (
          <ConnectEmbed
            client={client}
